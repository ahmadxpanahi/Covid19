...
class Caugh extends StatefulWidget {
  const Caugh({ Key key }) : super(key: key);

  @override
  _CaughState createState() => _CaughState();
}

class _CaughState extends State<Caugh> {
  var image = 'assets/images/caugh.png';
  var title = 'Caugh';
  @override
